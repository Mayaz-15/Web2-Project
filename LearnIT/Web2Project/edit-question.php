...
<head>
  ...
  <style>
  /* Same scoped system used in add-question.html */
  .quiz-scope{
    --qz-gap-1: 0.5rem;
    --qz-gap-2: 1rem;
    --qz-gap-3: 1.5rem;
    ...
    <div class="card-container">
      <section class="q-panel">
        ...
        <form class="flex-container" action="quiz.php" method="post" enctype="multipart/form-data">
          <input type="hidden" name="qid" value="q-001" />
          ...
          <fieldset>
            ...
            <div class="q-row">
              ...
              <textarea id="qtext" name="qtext" required>What is the output of the following code?
x = 5
y = 2
print(x // y)</textarea>
            </div>
            ...
            <div class="q-row">
              <label for="qfigure">Optional Figure (replace to update)</label>
              <input id="qfigure" name="qfigure" type="file" accept="image/*" />
              <p class="q-help">Leave empty to keep current figure (none).</p>
            </div>
            ...
            <div class="q-choices">
              <div class="q-row">
                ...
                <input id="c1" name="c1" type="text" required value="2.5" />
              </div>
              <div class="q-row">
                <label for="c2">Choice B</label>
                <input id="c2" name="c2" type="text" required value="2" />
              </div>
              <div class="q-row">
                <label for="c3">Choice C</label>
                <input id="c3" name="c3" type="text" required value="3" />
              </div>
              <div class="q-row">
                <label for="c4">Choice D</label>
                <input id="c4" name="c4" type="text" required value="Error" />
              </div>
            </div>
          ...
          <div class="q-inline">
            ...
            <a class="takeHome" href="quiz.html">Cancel</a>
            <button class="btn delete" href="quiz.php">Delete Question</button>
          </div>
        </form>
      </section>
    </div>
